...
const Lecture = () => {
  return (
    <div className="p-4 px-4 coding flex flex-col md:flex-row">
      {/* Left Content */}
      <div
        className="left-content mr-4 mb-4 sm:mb-0 overflow-y-scroll h-1/2 sm:h-[80vh] w-full sm:w-1/2 border-r-2"
      >
        <div>
      ...
      {/* Right Content */}
      <div
        className="right-content bg-gray-200 p-4 w-full sm:w-full md:w-1/2 h-1/2 sm:h-full"
      >
        <iframe
          id="compiler"
          frameBorder="0"
