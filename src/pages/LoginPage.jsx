              ...
              <div className="contact-us-form-holder">
                {isRegister ? (
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="needs-validation" id="post_form">
                      <input type="hidden" name="csrfmiddlewaretoken" value="k77RCqoCXlELdbY4JxlRMtwMFHAvBd7aZGccS8ySgkDsLsyKNUsxFfBSMyXOP7XK" />

                      <label htmlFor="username" className="form-label">Username</label>
                      <input
                        className={`form-control ${usernameValidationMessage ? 'is-invalid' : ''}`}
                        id="username"
                        type="text"
                        ...
                        required
                      />
                      <div className="invalid-feedback">{usernameValidationMessage}</div>
                      ...
                      <input
                        className={`form-control ${passwordValidationMessage ? 'is-invalid' : ''}`}
                        type="password"
                        ...
                        required
                      />
                      <div id="passwordValidation" className="invalid-feedback">{passwordValidationMessage}</div>

                      <button type="submit" id="loginBtn" onClick={handleAlert} disabled={isSubmitting}>Start Learning For Free</button>
                      <p className="terms">
                  ...
                  <>
                    ...
                    <div className="contact-us-or-line">
                      <h5 className="divide"><span>or</span></h5>
                    </div>
                    <form onSubmit={handleSubmit} className="needs-validation" id="post_form">
                      <input type="hidden" name="csrfmiddlewaretoken" value="UdM0s1WGANMNLuIt1S15ZC933VStWQMBzMRlIJ6WTMLujLi95f8LSoe9aMfMaKCb" />
                      ...
                      <input
                        ...
                        required
                      />
                      <div className="invalid-feedback">Please provide a valid username or email.</div>
